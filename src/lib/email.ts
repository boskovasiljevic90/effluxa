...
export async function sendFirstAuditReminderEmail({
  to,
}: {
  to: string;
}) {
  ...
  await resend.emails.send({
    from: fromEmail,
    to,
    subject: "Your first Effluxa audit is waiting",
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color:#0f172a;">
        <h2>Ready to find hidden financial leakage?</h2>

        <p>You created your Effluxa account, but haven’t uploaded your first financial file yet.</p>

        <p>Upload an invoice, statement, CSV export, or Excel report and Effluxa will generate your first AI financial leak audit.</p>
